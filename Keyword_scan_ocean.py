    ...
    try:
        with pdfplumber.open(file_path) as pdf:
            for page_number, page in enumerate(pdf.pages, start=1):
                # Define two columns for double-column layout
                ...
                # Extract and flatten table content
...
pdf_directory = "/Users/sophiawinter/Desktop/All English NDCs"

# Define keyword categories (truncated here for brevity - use full list in practice)
keyword_categories = {
    ...
    "General Ocean Mentions": [
        "ocean", "floods", "flood", "marine", "coast", "coastal", "coastal protection",
...
output_excel_path = "/Users/sophiawinter/Desktop/Storms_english.xlsx"
